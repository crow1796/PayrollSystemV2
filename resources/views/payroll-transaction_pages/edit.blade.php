...
@section('content')
	...
	<div class="row">
		{!! Form::model($transaction, ['method' => 'PUT', 'url' => url('payroll', $transaction->id)]) !!}
			<div class="col-sm-8">
				<div class="panel panel-default">
					...
					<div class="panel-body panel-body-active">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								{!! Form::text('cutoff_start', $transaction->cutoff_start->format('m/d/Y'), ['class' => 'form-control input-date', 'placeholder' => 'Cut-off Start']) !!}
							</div>
						</div>
						{{-- /.form-group --}}
						<div class="form-group row">
							...
							<div class="col-sm-9">
								{!! Form::text('cutoff_end', $transaction->cutoff_end->format('m/d/Y'), ['class' => 'form-control input-date', 'placeholder' => 'Cut-off End (Auto added 15days)']) !!}
							</div>
						</div>
						{{-- /.form-group --}}
					</div>
